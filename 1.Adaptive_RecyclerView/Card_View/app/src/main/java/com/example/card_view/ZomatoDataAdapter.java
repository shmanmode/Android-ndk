...
public class ZomatoDataAdapter extends RecyclerView.Adapter<ZomatoDataAdapter.ViewHolder> {
    private ArrayList<HotelData> hotel_data;
    private Context context;

    public ZomatoDataAdapter(Context context, ArrayList<HotelData> hotel_data) {
        this.context = context;
        this.hotel_data = hotel_data;
    }

    @Override
    public ZomatoDataAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
